methods_other = ["bardensr", "istdeco", "compressed_sensing", 'graph_iss', "spotsfirst"]

#methods_other = ["istdeco"]
#methods_other = ["bardensr", "compressed_sensing", 'graph_iss', "spotsfirst"]
