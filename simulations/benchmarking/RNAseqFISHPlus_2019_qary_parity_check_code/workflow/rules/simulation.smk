...
for code in codes_to_simulate["code"]:
    ...
    # seqFISH-family codebooks have no blank symbol: every round always carries a
    # real dot, and symbol 0 is rendered as an extra pseudocolor (code_q) rather than
    # being skipped -- see gen_sim_data.jl and get_cand_cpaths.jl's zeros_probed check.
