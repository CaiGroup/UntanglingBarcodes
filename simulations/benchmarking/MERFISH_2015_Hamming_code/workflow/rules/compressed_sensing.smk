for code in codes_to_simulate["code"]:
    ...
    rule:
        ...
        # Shares a group id with cs_find_cand_cpaths_with_negctrls, cs_l0learn_fit, and
        # score_compressed_sensing for this same condition so cluster execution submits them
        # as one scheduler job instead of several.
        group: f"compressed_sensing_{code}" + "_{rep}_{nbarcodes}_{nnonspec}_{pdrop}_{rstdv}"
...
rule cs_find_cand_cpaths_with_negctrls:
    ...
    # Same group id as cs_get_candidate_coords/cs_l0learn_fit/score_compressed_sensing for this
...
for code in codes_to_simulate["code"]:
    ...
    rule:
        ...
        # Shares a group id with cs_get_candidate_coords, cs_find_cand_cpaths_with_negctrls, and
        # score_compressed_sensing for this same condition so cluster execution submits them as
        # one scheduler job instead of several.
        group: f"compressed_sensing_{code}" + "_{rep}_{nbarcodes}_{nnonspec}_{pdrop}_{rstdv}"
